...
describe("pop", function () {
    ...
    it("throws error if empty list", function () {
        let lst = new LinkedList();
        let error;
...
describe("getAt", function () {
    ...
    it("throws error if invalid idx (positive)", function () {
    ...
    it("throws error if invalid idx (negative)", function () {
        let lst = new LinkedList([1, 2, 3]);
        let error;
...
describe("removeAt", function () {
    ...
    it("removes first node from list", function () {
